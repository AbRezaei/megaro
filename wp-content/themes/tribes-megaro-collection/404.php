...
<section class="error404-page" aria-labelledby="error404-title">
  <div class="error404-page__inner">
    ...
    <h1 id="error404-title" class="error404-page__title"><?php esc_html_e('Page Not Found', 'megaro'); ?></h1>
    <p class="error404-page__text"><?php esc_html_e('The page you are looking for does not exist or may have moved.', 'megaro'); ?></p>

    <div class="error404-page__actions">
      <a class="btn-fill" href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Back To Home', 'megaro'); ?></a>
    </div>
