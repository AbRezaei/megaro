...
class RestaurantImageContent extends \Elementor\Widget_Base
{
    use SharedControls;

    public function get_name(): string
    {
        return 'restaurant-image-content';
    }
        ...
        <section class="<?= $bg_color ?> <?= $text_color ?> lg:py-24 py-16">
            <div class="container">
                <div class="grid grid-cols-1 md:grid-cols-5 md:gap-x-8 lg:gap-x-16 xl:gap-x-24 gap-y-8">
                    ...
                    <div class="md:col-span-2 order-2 <?= $image_placement === 'right' ? 'md:order-1' : 'md:order-2' ?>">
                        ...
                        <?php endif; ?>
                        <h4 class="text-heading-4"><?= $title ?></h4>
                    ...
                    <div class="md:col-span-3 order-1 <?= $image_placement === 'right' ? 'md:order-2' : 'md:order-1' ?>">
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>"
                             class="w-full! md:h-180! h-82! object-cover object-center">
                    </div>
